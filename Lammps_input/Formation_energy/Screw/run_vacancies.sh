...
OUTPUT_FILE="Zn_vacancy_energies_Screw_core35.txt"

# Original dump-style ID file
ID_FILE="core_Zn_ids_after_min_Screw_873K_intrinsic_Fixed_CorrectPipe.txt"
...
awk '
  ...
  read_atoms==1 && $1 ~ /^[0-9]+$/ && $2 == 1 {print $1}
